...
class DIV2K(srdata.SRData):
    ...
    def _set_filesystem(self, dir_data):
        ...
        self.dir_hr = os.path.join(self.apath ,'High Resolution Images', 'DIV2K_train_HR')
        self.dir_lr = os.path.join(self.apath,'Low Resolution Images','DIV2K_train_LR_bicubic_X{}'.format(self.scale[0]))
        self.ext = '.png'
