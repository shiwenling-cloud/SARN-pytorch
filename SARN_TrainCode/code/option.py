...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/shiwenling/DCSCN/DCSCN-super-resolution-master/data/',
...
parser.add_argument('--model', default='SARN',
                    help='model name')
...
parser.add_argument('--extend', type=str, default='.',
                    help='pre-trained model directory')
parser.add_argument('--n_BSAMs', type=int, default=20,
...
parser.add_argument('--reset', action='store_true',#开关作用，表示reset=True
...
# Log specifications
parser.add_argument('--save', type=str, default='SARN',
                    help='file name to save')
parser.add_argument('--load', type=str, default='.',
                    help='file name to load')
parser.add_argument('--resume', type=int, default=0,
                    help='resume from specific checkpoint')
parser.add_argument('--print_model', action='store_false',
                    help='print model')
...
# x是定义的变量用来遍历args.scale.split('+')中的所有值，int(x)就是args.scale.split('+')中的各个数分别转换为int，然后创建有int(x)函数返回的列表。
